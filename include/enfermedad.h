 ...
 * Descripción contiene toda la información asociada a una enfermedad almacenada 
 * en la BD ClinVar-dbSNP (nombre de la enfermedad, id, BD que provee el id)
